...
const FrecuentesContainer = ({eventList}) => {
    ...
    return (
        ...
        <div className="backgroundPages bg-frecuentes">
            ...
            <p style={{ fontSize: 18, color: "white", textAlign: "justify" }}>Forma parte de nuestras clases y actividades dinámicas, Eventos diseñados para ofrecerte un espacio de aprendizaje, interacción y crecimiento personal.</p>
            {
